      ...
      <div className="top flex items-start justify-between px-5 py-5 max-sm:flex-col max-md:flex-col">
        <div className="grid grid-cols-1 gap-12">
          <div className="company-info">
            ...
            <p>
              We are dedicated to helping <br /> improve your cooking experience
            </p>
          </div>
          <ul className="grid grid-cols-1 gap-4">
            <h2 className="text-[1.5rem] font-[600]">Our Socials</h2>
        ...
        <ul className="grid grid-cols-1 gap-4">
          <h2 className="text-[1.5rem] font-[700]">Navigation</h2>
          <li>
            <a href="#">Home</a>
          </li>
          <li>
        ...
        {/* Contact us */}
        <ul className="grid grid-cols-1 gap-4">
          <h2 className="text-[1.5rem] font-[700]">Contact Us</h2>
          <li>13, Muhammed Ahmadu </li>
          <li>Way, Oshore Estate, Lekki</li>
          <li>Expressway, Lagos, Nigeria.</li>
          <li>cookware@email.org</li>
          <li>+234 8000 4565 34</li>
        </ul>
        {/* Opening hours */}
        <ul className="grid grid-cols-1 gap-4">
          <h2 className="text-[1.5rem] font-[700]">Opening Hours</h2>
          <li>Mon-Fri 8:00am-7:00pm</li>
          <li>Sat-Sun: 12:00am-6:00pm</li>
        </ul>
      </div>

      <small className="text-center block py-2">
        Copyright © 2024 Acookware
      </small>
    </footer>
  );
};
